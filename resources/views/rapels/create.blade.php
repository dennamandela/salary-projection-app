...
@section('title', 'Tambah Data Rapel Kekurangan')

@section('content_header')
    <h1 class="m-0 text-dark">Tambah Data Rapel Kekurangan</h1>
@stop

@section('content')
    <form action="{{route('rapels.store')}}" method="post">
        @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{route('rapels.index')}}" class="btn btn-default">
                        Batal
                    </a>
                </div>
            </div>
